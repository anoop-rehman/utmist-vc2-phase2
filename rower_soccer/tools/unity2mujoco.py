...
def emit_xml(phenotypes, model_name, gear_scale=1.0, joint_range=(-75, 75),
    ...
    <!-- GENERATED by rower_soccer/tools/unity2mujoco.py. Do not hand-edit.
         ...
         -> {total_mass:.2f} kg
         Regenerate:
           python -m rower_soccer.tools.unity2mujoco --input <.creature> \\
             --out <this file> --name {model_name} \\
             --gear-scale {gear_scale:g} --length-scale {s:g}
         The gear_scale is NOT reconstructible from the XML alone -- an earlier
         worm was checked in at gear_scale=0.03 with that fact recorded nowhere,
         so a later regeneration at the default 1.0 silently made it 33x
         stronger. Hence this header. -->
