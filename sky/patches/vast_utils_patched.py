...
def launch(name: str,
    ...
    # NOTE(workaround): vastai-sdk 1.4.2 silently drops ALL filters when any
    # query token contains quotes or spaces (e.g. gpu_name="RTX 3090"),
    # causing arbitrary machines to be rented. Use underscored, unquoted
    # values, which the SDK parses correctly.
